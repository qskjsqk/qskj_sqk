        ...
        if (data.flag == 1) {
            ...
            for (var i = 0; i < data.data.length; i++) {
                str += '<div class="pinglun-list m-margin-l5 m-padding-lr10 m-margin-t10 m-padding-b10" style="border-bottom: 1px solid #e2e2e2;">' +
                        ...
                        '<p>' + data.data[i]['tel'] + '</p>' +
                        '</div>' +
                        '<button type="button" class="mui-btn mui-btn-outlined m-display-no" style="float: right; border: 0px;" onclick="callPhone()" ><span class="mui-icon mui-icon-phone" style="font-size: 26px;"></span></button>' +
        ...
        if (data.flag == 1) {
            ...
            for (var i = 0; i < data.data.length; i++) {
                str += '<div class="pinglun-list m-margin-l5 m-padding-lr10 m-margin-t10 m-padding-b10" style="border-bottom: 1px solid #e2e2e2;">' +
                        ...
                        '<p>' + data.data[i]['tel'] + '</p>' +
                        '</div>' +
                        '<button type="button" class="mui-btn mui-btn-outlined m-display-no" style="float: right; border: 0px;"><span class="mui-icon mui-icon-phone" style="font-size: 26px;"></span></button>' +
