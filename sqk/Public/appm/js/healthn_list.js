...
//                        '</li>';
                ...
                str += '<li class="mui-table-view-cell" style="padding-right: 10px;" onclick="getHealthnDetail(' + data.data[i]['id'] + ',' + cat_id + ')">' +
                        '<a href="javascript:;">' +
                                '<div class="imghealthn">'+getFirstImg(data.data[i]['content'])+'</div>' +
                                '<div class="mui-media-body">' +
                                    '<p class="mui-ellipsis" style="color:#555;"><font color="#c00000">['+data.data[i]['cat_name'] + ']</font>&#12288;' + data.data[i]['title'] + '</p>' +
