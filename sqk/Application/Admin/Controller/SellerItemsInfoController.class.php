...
class SellerItemsInfoController extends BaseDBController {
    ...
    public function showItemsInfo() {
        if (GET) {
            ...
            if (!empty($_GET['cat_id'])) {
                $where['qs_gryj_seller_items_info.cat_id'] = array('EQ', $_GET['cat_id']);
    ...
    public function saveSellerItems() {
        if (IS_POST) {
            ...
            if ($this->infoModel->create($sellerItemsInfo)) {
                ...
                $logC = A('Actionlog')->addLog('SellerItemsInfo', 'saveSellerItems', '添加/编辑商家服务项目信息');
                if ($result !== false) {
    ...
    public function delArrayItemsInfo() {
        ...
        $logC = A('Actionlog')->addLog('SellerItemsInfo', 'delArrayItemsInfo', '删除商家服务项目信息');
        $this->ajaxReturn($returnData, 'JSON');
    }

    /**
     * function:审核单条商家服务项目信息
     */
    ...
    public function checkArrayItemsInfo() {
        ...
        $logC = A('Actionlog')->addLog('SellerItemsInfo', 'checkArrayItemsInfo', '审核商家服务项目信息');
        $this->ajaxReturn($returnData, 'JSON');
    }
