                    ...
                    <ul id="main-nav" class="nav nav-list nav-stacked">
                        ...
                        <li class="sellerMenu">
                            ...
                            <ul id="div2" class="nav nav-list collapse secondmenu" style="height: 0px;">
                                <li class="perfectInfo"><div onclick="jumpPage('/index.php/Admin/SellerInfo/perfectInfo', this)"  class="li-color-3">完善基本信息</div></li>
                        ...
                        <li class="appuserMenu">
                            ...
                            <ul id="div6" class="nav nav-list collapse secondmenu" style="height: 0px;">
                                <li class="showappUserInfo"><div onclick="jumpPage('/index.php/Admin/SysUserAppInfo/showList', this)"  class="li-color-1" >居民信息</div></li>
                                <li class="showsellerInfo"><div onclick="jumpPage('/index.php/Admin/SysUserInfo/showList', this)"  class="li-color-1" >商家信息</div></li>
                            </ul>
                        </li>
                        <li class="systemMenu">
