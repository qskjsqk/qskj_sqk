...
public class GlidePieceRoundTransform implements Transformation<Bitmap> {
    ...
    public GlidePieceRoundTransform(Context context, int radius, CornerType type) {
        mBitmapPool = Glide.get(context).getBitmapPool();
        mCornerType = type;
        mRadius = DensityUtil.dip2px(radius);
        mDiameter = mRadius * 2;
    }
