...
public class T {
     ...
     * @param s
     */
    public static void showLongTime(long t, String s) {
        final Timer timer = new Timer();
        final Toast toast = Toast.makeText(ContextUtil.getAppContext(), s, Toast.LENGTH_LONG);
     ...
     * @param s
     */
    public static void showLongTime(String s) {
        showLongTime(5000, s);
    }
}