...
public class MultipartRequest extends SimpleRequest {
     ...
     * 文本参数和字符集
     */
    private final static String TYPE_TEXT_CHARSET = "text/plain; charset=UTF-8";
    /**
     * 字节流参数
     */
    private final static String TYPE_OCTET_STREAM = "application/octet-stream";
    /**
     * 二进制参数
     */
    private final static byte[] BINARY_ENCODING = "Content-Transfer-Encoding: binary\r\n\r\n".getBytes();
    /**
     * 文本参数
     */
    private final static byte[] BIT_ENCODING = "Content-Transfer-Encoding: 8bit\r\n\r\n".getBytes();
    /**
     * 输出流
     */
    ByteArrayOutputStream mOutputStream = new ByteArrayOutputStream();
    private Map<String, Object> mParam = Collections.emptyMap();
