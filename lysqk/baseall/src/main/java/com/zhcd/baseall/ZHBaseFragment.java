...
public abstract class ZHBaseFragment extends Fragment {
...
//        L.d("Fragment:::-->>onActivityCreated");
    ...
    private View initRootView(LayoutInflater layoutInflater, ViewGroup container) {
        ...
        titleBarBuilder = new TitleBar(getActivity(), toolbar);
    ...
    /**
     * ZHBaseFragment 添加view绑定使用 具体Fragment不需要Override该方法
     *
     * @param view
     */
